...
<div class="login-box">
    ...
    <form method="post" action="#">
        ...
        <div class="row">
            <div class="col-11">
                <div class="user-box">
                    <input type="password" name="senha" id="senha" autocomplete="off" required maxlength="8">
                    <label>Senha <span class="mdi mdi-key"></span></label>
                </div>
            </div>
            <div class="col-1">
                <button id="iconeOlho" type="button" style="background: transparent; border: transparent; box-shadow: transparent"
