    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10 mt-3">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header" style="background: #1E2B37;color: white">
                                ...
                                <button type="button" class="btn-close text-light" onclick="window.location.reload()" aria-label="Close" style="color: white !important; background-color: #2c3e50"></button>
                            </div>
                            <form method="post" name="frmAddEvento" id="frmAddEvento">
                                <div class="modal-body">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Título</span>
                                        <input type="text" class="form-control" placeholder="Título" aria-label="Título" id="titulo" name="titulo">
                                    </div>
                                    <div class="input-group mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example" id="curso" name="curso">
                                            <?php
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" placeholder="dataIn" aria-label="dataIn" id="dataIn" name="dataIn" value="<?php echo DATATIMEATUAL ?>" required="required">
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="dataEnd">Data e Hora Final</span>
                                        <input type="datetime-local" class="form-control" placeholder="dataEnd" aria-label="dataEnd" id="dataEnd" name="dataEnd" value="<?php echo DATATIMEATUAL ?>">
                                    </div>
                                    <div class="input-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" placeholder="Escreva um comentário" maxlength="255" id="comentario" name="comentario"></textarea>
                                </div>
                ...
                <!-- Modal Edit Evento-->
                <div class="modal fade" id="editEvento" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header" style="background: #1E2B37;color: white">
                            ...
                            <form method="post" name="frmEditEvento" id="frmEditEvento">
                                <div class="modal-body">
                                    ...
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Título</span>
                                        <input type="text" class="form-control" placeholder="Título" aria-label="Título" id="tituloEdit" name="tituloEdit">
                                    </div>
                                    <div class="input-group mb-3">

                                        <span class="input-group-text">Turma</span>
                                        <select class="form-select" aria-label="Default select example" id="turmaEdit" name="turmaEdit">
                                            <?php
                                            $turmas = listarTabela('*', 'turma');
                                            foreach ($turmas as $turma) {
                                                $idturma = $turma->idturma;
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <span class="input-group-text">Curso</span>
                                        <select class="form-select" aria-label="Default select example" id="cursoEdit" name="cursoEdit">
                                            <?php
                                            $cursos = listarTabela('*', 'curso');
                                            foreach ($cursos as $item) {
                                                $idturma = $item->idcurso;
                                    ...
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="dataIn">Data e Hora Inicial</span>
                                        <input type="datetime-local" class="form-control" placeholder="dataIn" aria-label="dataIn" id="dataInEdit" name="dataInEdit" value="">
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="dataEnd">Data e Hora Final</span>
                                        <input type="datetime-local" class="form-control" placeholder="dataEnd" aria-label="dataEnd" id="dataEndEdit" name="dataEndEdit" value="">
                                    </div>
                                    <div class="input-group mb-3">

                                        <span class="input-group-text" id="cor">Cores</span>
                                        <select class="form-select" aria-label="Default select example" id="corEdit" name="corEdit">
                                            <option value="blue" style="color:blue" selected>Azul</option>
                                            <option value="gray" style="color:gray">Cinza</option>
                                            <option value="green" style="color:green">Verde</option>
                                            <option value="red" style="color:red">Vermelho</option>
                                ...
                                <div class="input-group">
                                    <label class="input-group-text" for="comentário">Comentários</label>
                                    <textarea class="form-control" placeholder="Escreva um comentário" maxlength="255" id="comentarioEdit" name="comentarioEdit"></textarea>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar
                                    </button>
                ...
                <div class="modal fade" id="verMaisEvento" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog  modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header" style="background: #1E2B37;color: white">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input  disabled type="text"  style='background:transparent; border:none;' class=" text-center form-control" placeholder="Título" aria-label="Título" id="tituloVerMais" name="tituloVerMais">


                                    <h3 class='text-center'>Turma</h3>

                                    <input  disabled type="text" id='turmaVerMais' name='turmaVerMais'  style='background:transparent; border:none;' class="text-center form-control">
                                    ...
                                    <input  disabled type="datetime-local"  style='background:transparent; border:none;' class="text-center form-control" placeholder="dataIn" aria-label="dataIn" id="dataInVerMais" name="dataInVerMais" value="">

                                    <h3 class='text-center' id="dataEnd">Data e Hora Final</h3>

                                    <input  disabled type="datetime-local"  style='background:transparent; border:none;' class="text-center form-control" placeholder="dataEnd" aria-label="dataEnd" id="dataEndVerMais" name="dataEndVerMais" value="">


                                    <h3 class='text-center' id="cor" name='cor'>Cores</h3>
                                    ...
                                    <textarea  disabled  style='background:transparent; border:none;' class="text-center form-control" placeholder="Escreva um comentário" maxlength="255" id="comentarioVerMais" name="comentarioVerMais"></textarea>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar
                                    </button>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="cadNomeAluno" id="cadNomeAluno" class="form-control" required="required">
                                    </div>
                                    <div class="col-6">
                                        <label for="cadSobrenomeAluno" class="label-control">Sobrenome:</label>
                                        <input type="text" name="cadSobrenomeAluno" id="cadSobrenomeAluno" class="form-control" required="required">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-8">
                                ...
                                <input type="email" name="cadEmailAluno" id="cadEmailAluno" class="form-control" required="required">
                            </div>
                            <div class="col-4">
                                <label for="cadCelularAluno" class="label-control">Celular:</label>
                                <input type="text" name="cadCelularAluno" id="cadCelularAluno" class="form-control telefoneBR" required="required">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
                                <label for="cadCpfAluno" class="label-control">Cpf:</label>
                                <input type="text" name="cadCpfAluno" id="cadCpfAluno" class="form-control cpf" required="required">
                            </div>
                            <div class="col-6">
                                <label for="cadNascimentoAluno" class="label-control">Data de nascimento:</label>
                                <input type="date" name="cadNascimentoAluno" id="cadNascimentoAluno" class="form-control" required="required">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="editNomeAluno" id="editNomeAluno" class="form-control" required="required">
                                    </div>
                                    <div class="col-6">
                                        <label for="editSobrenomeAluno" class="label-control">Sobrenome:</label>
                                        <input type="text" name="editSobrenomeAluno" id="editSobrenomeAluno" class="form-control" required="required">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-8">
                                ...
                                <input type="email" name="editEmailAluno" id="editEmailAluno" class="form-control" required="required">
                            </div>
                            <div class="col-4">
                                <label for="editCelularAluno" class="label-control">Celular:</label>
                                <input type="text" name="editCelularAluno" id="editCelularAluno" class="form-control telefoneBR" required="required">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
                                <label for="editCpfAluno" class="label-control">Cpf:</label>
                                <input type="text" name="editCpfAluno" id="editCpfAluno" class="form-control cpf" required="required">
                            </div>
                            <div class="col-6">
                                <label for="editNascimentoAluno" class="label-control">Data de nascimento:</label>
                                <input type="date" name="editNascimentoAluno" id="editNascimentoAluno" class="form-control" required="required">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <form action="" method="post" name="frmDeleteAluno" id="frmDeleteAluno">
                    <div class="modal-body">
                        ...
                        <div>
                            <input type="checkbox" name="confimacaoDeleteAluno" id="confimacaoDeleteAluno" required="required">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="cadNomeAdm" id="cadNomeAdm" class="form-control" required="required">
                                    </div>
                                    <div class="col-6">
                                        <label for="cadSobrenomeAdm" class="label-control">Sobrenome:</label>
                                        <input type="text" name="cadSobrenomeAdm" id="cadSobrenomeAdm" class="form-control" required="required">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-8">
                                ...
                                <input type="email" name="cadEmailAdm" id="cadEmailAdm" class="form-control" required="required">
                            </div>
                            <div class="col-4">
                                <label for="cadSenhaAdm" class="label-control">Senha:</label>
                                <input type="text" name="cadSenhaAdm" id="cadSenhaAdm" class="form-control" required="required">
                            </div>
                            <div class="col-12 mt-2">
                                <label for="cadCelularAdm" class="label-control">Celular:</label>
                                <input type="text" name="cadCelularAdm" id="cadCelularAdm" class="form-control telefoneBR" required="required">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
                                <label for="cadCpfAdm" class="label-control">Cpf:</label>
                                <input type="text" name="cadCpfAdm" id="cadCpfAdm" class="form-control cpf" required="required">
                            </div>
                            <div class="col-6">
                                <label for="cadNascimentoAdm" class="label-control">Data de nascimento:</label>
                                <input type="date" name="cadNascimentoAdm" id="cadNascimentoAdm" class="form-control" required="required">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="editNomeAdm" id="editNomeAdm" class="form-control" required="required">
                                    </div>
                                    <div class="col-6">
                                        <label for="editSobrenomeAdm" class="label-control">Sobrenome:</label>
                                        <input type="text" name="editSobrenomeAdm" id="editSobrenomeAdm" class="form-control" required="required">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-8">
                                ...
                                <input type="email" name="editEmailAdm" id="editEmailAdm" class="form-control" required="required">
                            </div>
                            <div class="col-4">
                                <label for="editSenhaAdm" class="label-control">Senha:</label>
                                <input type="text" name="editSenhaAdm" id="editSenhaAdm" class="form-control" required="required">
                            </div>
                            <div class="col-12 mt-2">
                                <label for="editCelularAdm" class="label-control">Celular:</label>
                                <input type="text" name="editCelularAdm" id="editCelularAdm" class="form-control telefoneBR" required="required">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
                                <label for="editCpfAdm" class="label-control">Cpf:</label>
                                <input type="text" name="editCpfAdm" id="editCpfAdm" class="form-control cpf" required="required">
                            </div>
                            <div class="col-6">
                                <label for="editNascimentoAdm" class="label-control">Data de nascimento:</label>
                                <input type="date" name="editNascimentoAdm" id="editNascimentoAdm" class="form-control" required="required">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                ...
                <form action="" method="post" name="frmCadCurso" id="frmCadCurso">
                    <div class="modal-body">
                        <div class="">
                            ...
                            <input type="text" name="cadNomeCurso" id="cadNomeCurso" required="required" class="form-control">
                        </div>
                        <div class="mt-2">
                            <label for="cadLocalCurso" class="label-control">Local do curso:</label>
                            <input type="text" name="cadLocalCurso" id="cadLocalCurso" required="required" class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                ...
                <form action="" method="post" name="frmEditCurso" id="frmEditCurso">
                    <div class="modal-body">
                        ...
                        <div class="">
                            ...
                            <input type="text" name="editNomeCurso" id="editNomeCurso" required="required" class="form-control">
                        </div>
                        <div class="mt-2">
                            <label for="editLocalCurso" class="label-control">Local do curso:</label>
                            <input type="text" name="editLocalCurso" id="editLocalCurso" required="required" class="form-control">
                        </div>
            ...
            <div class="modal-content">
                ...
                <form action="" method="post" name="frmDeleteCurso" id="frmDeleteCurso">
                    <div class="modal-body">
                        ...
                        <div>
                            <input type="checkbox" name="confimacaoDeleteCurso" id="confimacaoDeleteCurso" required="required">
                ...
                <form action="" method="post" name="frmCadTurma" id="frmCadTurma">
                    <div class="modal-body">
                        <div>
                            ...
                            <input type="text" name="cadNumeroTurma" id="cadNumeroTurma" required="required" class="form-control">
                        </div>
                        <div class="mt-2">
                            <label for="cadNomeTurma" class="label-control">Nome da turma:</label>
                            <input type="text" name="cadNomeTurma" id="cadNomeTurma" required="required" class="form-control">
                        </div>
                        <div class="mt-2">
                            <label for="cadCodigoTurma" class="label-control">Código da turma:</label>
                            <input type="text" name="cadCodigoTurma" id="cadCodigoTurma" required="required" class="form-control">
                        </div>
                ...
                <form action="" method="post" name="frmEditTurma" id="frmEditTurma">
                    <div class="modal-body">
                        <div class="">
                            ...
                            <input type="text" name="editNumeroTurma" id="editNumeroTurma" required="required" class="form-control">
                        </div>
                        <div class="mt-2">
                            <label for="editNomeTurma" class="label-control">Nome da turma:</label>
                            <input type="text" name="editNomeTurma" id="editNomeTurma" required="required" class="form-control">
                        </div>
                        <div class="mt-2">
                            <label for="editCodigoTurma" class="label-control">Código da turma:</label>
                            <input type="text" name="editCodigoTurma" id="editCodigoTurma" required="required" class="form-control">
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="" method="post" name="frmDeleteTurma" id="frmDeleteTurma">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-bs-dismiss="modal" onclick="fecharModal('listarTurma')">Fechar
                        </button>
                        <button type="submit" class="btn btn-danger" id="btnDeleteAdm">Deletar</button>
                    </div>
                </form>
